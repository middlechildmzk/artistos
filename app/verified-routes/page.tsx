...
export const metadata: Metadata = {
  ...
  description: "A public pilot of independently verified music submission routes for radio, press, and sync, with current requirements, official sources, and verification dates.",
...
export default function VerifiedRoutesPage() {
  const itemListJsonLd = {
    ...
    itemListElement: publicVerifiedRoutes.map((route, index) => ({
      "@type": "ListItem",
      position: index + 1,
      name: route.name,
      url: route.source,
    ...
    <main>
      ...
      <div className="shell">
        ...
        <section className="card release-card" style={{ padding: 38, marginBottom: 18 }}>
          ...
          <div className="nav-links" style={{ marginTop: 18 }}><span className="pill">{publicVerifiedRoutes.length} public verified route records</span><span className="pill">official-source checked</span><span className="pill">dated verification</span></div>
        </section>
        ...
        <section className="card" style={{ marginBottom: 18 }}>
          ...
          <div className="stack" style={{ marginTop: 12 }}>
            {publicVerifiedRoutes.map((route) => (
