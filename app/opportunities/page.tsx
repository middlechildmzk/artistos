  ...
  return (
    <main className="shell">
      ...
      <section className="grid two-col" style={{ marginBottom: 16 }}>
        <form action={createOpportunitySearch} className="card stack">
        ...
        <div className="card stack">
          ...
          <div className="row"><span>YouTube Data API</span><span className="pill">Server key required</span></div>
      ...
      <section className="card" style={{ marginBottom: 16 }}>
        ...
        <div className="grid three-col">
          <div><strong>Follower count alone never determines quality</strong><p className="muted">Reach is one bounded feature. Fit, legitimacy, accessibility, relationship context, freshness, and risk remain separate.</p></div>
      ...
      <section className="card" style={{ marginBottom: 16 }}>
        ...
        {searches.length ? searches.map((search) => {
          ...
          return <article className="directory-row" key={search.id}>
            ...
            <form action={executeOpportunitySearch} className="nav-links"><input type="hidden" name="searchId" value={search.id} /><input type="hidden" name="maxResultsPerLane" value="12" /><button className="button primary" type="submit" disabled={!runtimeReady}>Run approved sources</button></form>
          </article>;
