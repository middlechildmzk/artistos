...
export default async function ApprovalCenterPage() {
  ...
  return <main className="shell">
    ...
    <section className="card release-card" style={{ marginBottom: 16 }}><div className="eyebrow">Human authority</div><h1>Review what ArtistOS may do, and why</h1><p className="muted">Protected actions preserve frozen inputs, policy decisions, execution receipts, and source-level evidence provenance.</p></section>
