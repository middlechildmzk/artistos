...
export default async function StudioPage() {
  ...
  return <>
    ...
    <header className="app-page-heading"><div><div className="eyebrow">Content belonging to each release</div><h1>Creator tools</h1><p>Turn release strategy into platform-ready hooks, concepts, captions and a practical publish queue.</p></div><nav className="section-tabs" aria-label="Release tools"><Link href="/releases">Releases</Link><Link href="/links">Music links</Link><Link className="active" href="/studio">Creator tools</Link></nav></header>
